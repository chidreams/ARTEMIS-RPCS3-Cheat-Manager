...
def launch_gui():
    ...
    class App(tk.Tk):
        ...
        def _on_sync_done(self, success, result):
            ...
            if success:
                if result:
                    ...
                    # Auto-switch to Library tab so they can see the NEW files
                    self.nb.select(1)
                else:
        ...
        def _build_details(self, parent):
            ...
            self._apply_context_menu(self.detail) # CONTEXT MENU
        ...
        def delete_selected(self):
            ...
            # If they selected a specific cheat
            ...
            # If they selected a parent game folder
                ...
                if messagebox.askyesno("Delete game", f"Delete the entire game '{game_name}' and all {len(game_cheats)} of its cheats?"):
                    # Calculate ranges manually and cut backwards so shifting lines don't break the offsets
